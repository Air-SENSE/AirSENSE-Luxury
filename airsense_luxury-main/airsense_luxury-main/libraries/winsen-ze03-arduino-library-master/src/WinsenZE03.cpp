...
void WinsenZE03::setAs(bool active){
  byte setConfig[] = {0xFF, 0x01, 0x86, 0x00, 0x00, 0x00, 0x00, 0x00, 0x79};//QA config
...
float WinsenZE03::readContinuous(){
  if (_s->available() > 0) {
	...
	Serial.print(measure[0],HEX);Serial.print(" ");
	Serial.print(measure[1],HEX);Serial.print(" ");
	Serial.print(measure[2],HEX);Serial.print(" ");
	Serial.print(measure[3],HEX);Serial.print(" ");
	Serial.print(measure[4],HEX);Serial.print(" ");
	Serial.print(measure[5],HEX);Serial.print(" ");
	Serial.print(measure[6],HEX);Serial.print(" ");
	Serial.print(measure[7],HEX);Serial.print(" ");
	Serial.print(measure[8],HEX);Serial.print(" ");
	Serial.println(ppm);
    return ppm;
  }
}
...
float WinsenZE03::readManual(){
  float ppm;
  byte petition[] = {0xFF,0x01, 0x78, 0x40, 0x00, 0x00, 0x00, 0x00, 0x47};// Petition to get a single result
